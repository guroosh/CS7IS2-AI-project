...
def dfs(grid_world, key):
    ...
    if x == grid_world.end_x and y == grid_world.end_y:
        ...
        grid_world.final_route.append((x, y))
        return -1
    ...
    for l in adjacent_nodes:
        if grid_world.is_visited[l[0]][l[1]] == 0:
            ...
            if ret_val == -1:
                grid_world.final_route.append((l[0], l[1]))
                return -1
...
def run_dfs(grid_world):
    ...
    grid_world.final_route.append((grid_world.start_x, grid_world.start_y))
    grid_world.final_route = grid_world.final_route[::-1]
